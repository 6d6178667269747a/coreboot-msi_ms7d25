...
static const struct pad_config gpio_table[] = {
	...
	_PAD_CFG_STRUCT(GPP_A17, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE) | 1, 0),
	...
	_PAD_CFG_STRUCT(GPP_A22, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_A23 - GPIO */
	/* DW0: 0x84000201, DW1: 0x00000000 */
	/* PAD_CFG_GPO(GPP_A23, 1, PLTRST), */
	_PAD_CFG_STRUCT(GPP_A23, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE) | 1, 0),
	...
	_PAD_CFG_STRUCT(GPP_B0, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),

	/* GPP_B1 - GPIO */
	/* DW0: 0x44000200, DW1: 0x00000000 */
	/* PAD_CFG_GPO(GPP_B1, 0, DEEP), */
	_PAD_CFG_STRUCT(GPP_B1, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_B3, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),

	/* GPP_B4 - GPIO */
	/* DW0: 0x84000102, DW1: 0x00000000 */
	/* DW0: (1 << 1) - IGNORED */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_B4, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_B4, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	_PAD_CFG_STRUCT(GPP_B10, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_B16, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_B17 - GPIO */
	/* DW0: 0x84000102, DW1: 0x00000000 */
	/* DW0: (1 << 1) - IGNORED */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_B17, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_B17, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),

	/* GPP_B18 - GPIO */
	/* DW0: 0x84000200, DW1: 0x00000000 */
	/* PAD_CFG_GPO(GPP_B18, 0, PLTRST), */
	_PAD_CFG_STRUCT(GPP_B18, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),

	/* GPP_B19 - GSPI1_CS# */
	/* DW0: 0x84000600, DW1: 0x00000000 */
	/* DW0: PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE) - IGNORED */
	/* PAD_CFG_NF(GPP_B19, NONE, PLTRST, NF1), */
	_PAD_CFG_STRUCT(GPP_B19, PAD_FUNC(NF1) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_B22, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),

	/* GPP_B23 - SML1ALERT# */
	/* DW0: 0x84000500, DW1: 0x00001000 */
	/* DW0: PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) - IGNORED */
	/* PAD_CFG_NF(GPP_B23, DN_20K, PLTRST, NF1), */
	_PAD_CFG_STRUCT(GPP_B23, PAD_FUNC(NF1) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), PAD_PULL(DN_20K)),
	...
	_PAD_CFG_STRUCT(GPP_C2, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	_PAD_CFG_STRUCT(GPP_C5, PAD_FUNC(NF1) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_C8, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	//_PAD_CFG_STRUCT(GPP_C15, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),
	PAD_CFG_GPO(GPP_C15, 1, PLTRST), // M.2_WLAN_DISABLE#

	/* GPP_C16 - I2C0_SDA */
	/* DW0: 0x44000500, DW1: 0x00000000 */
	/* DW0: PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) - IGNORED */
	/* PAD_CFG_NF(GPP_C16, NONE, DEEP, NF1), */
	_PAD_CFG_STRUCT(GPP_C16, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_C17 - I2C0_SCL */
	/* DW0: 0x44000500, DW1: 0x00000000 */
	/* DW0: PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) - IGNORED */
	/* PAD_CFG_NF(GPP_C17, NONE, DEEP, NF1), */
	_PAD_CFG_STRUCT(GPP_C17, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_C18 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_C18, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_C18, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_C23, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_D9, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE) | 1, 0),

	/* GPP_D10 - GPIO */
	/* DW0: 0x84000201, DW1: 0x00000000 */
	/* PAD_CFG_GPO(GPP_D10, 1, PLTRST), */
	_PAD_CFG_STRUCT(GPP_D10, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE) | 1, 0),
	...
	_PAD_CFG_STRUCT(GPP_D13, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_D15, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),

	/* GPP_D16 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_D16, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_D16, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_D17 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_D17, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_D17, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_D18 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_D18, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_D18, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_D23, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_E0, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	_PAD_CFG_STRUCT(GPP_E7, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	/* GPP_F1 - SATAXPCIE4 */
	/* DW0: 0x42080502, DW1: 0x00000000 */
	/* DW0: PAD_TRIG(EDGE_SINGLE) | PAD_BUF(TX_DISABLE) | (1 << 1) - IGNORED */
	/* PAD_CFG_NF(GPP_F1, NONE, DEEP, NF1), */
	_PAD_CFG_STRUCT(GPP_F1, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(EDGE_SINGLE) | PAD_IRQ_ROUTE(SCI) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),

	/* GPP_F2 - SATAXPCIE5 */
	/* DW0: 0x42080502, DW1: 0x00000000 */
	/* DW0: PAD_TRIG(EDGE_SINGLE) | PAD_BUF(TX_DISABLE) | (1 << 1) - IGNORED */
	/* PAD_CFG_NF(GPP_F2, NONE, DEEP, NF1), */
	_PAD_CFG_STRUCT(GPP_F2, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(EDGE_SINGLE) | PAD_IRQ_ROUTE(SCI) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	_PAD_CFG_STRUCT(GPP_F6, PAD_RESET(RSMRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	_PAD_CFG_STRUCT(GPP_F12, PAD_RESET(PLTRST) | PAD_IRQ_ROUTE(IOAPIC) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),

	/* GPP_F13 - GPIO */
	/* DW0: 0x80100100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_APIC_HIGH(GPP_F13, NONE, PLTRST), */
	_PAD_CFG_STRUCT(GPP_F13, PAD_RESET(PLTRST) | PAD_IRQ_ROUTE(IOAPIC) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_F14 - GPIO */
	/* DW0: 0x40100100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_APIC_HIGH(GPP_F14, NONE, DEEP), */
	_PAD_CFG_STRUCT(GPP_F14, PAD_RESET(DEEP) | PAD_IRQ_ROUTE(IOAPIC) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_F19, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_F20 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_F20, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_F20, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_F21 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_F21, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_F21, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_F22 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_F22, NONE), */
	_PAD_CFG_STRUCT(GPP_F22, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),
	...
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_G0, NONE), */
	_PAD_CFG_STRUCT(GPP_G0, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_G1 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_G1, NONE), */
	_PAD_CFG_STRUCT(GPP_G1, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_G2 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_G2, NONE), */
	_PAD_CFG_STRUCT(GPP_G2, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_G3 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_G3, NONE), */
	_PAD_CFG_STRUCT(GPP_G3, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_G4 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_G4, NONE), */
	_PAD_CFG_STRUCT(GPP_G4, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_G5 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_G5, NONE), */
	_PAD_CFG_STRUCT(GPP_G5, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_G12, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_G13 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_G13, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_G13, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_G14 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_G14, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_G14, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_G15 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_G15, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_G15, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_G16 - GPIO */
	/* DW0: 0x84000102, DW1: 0x00000000 */
	/* DW0: (1 << 1) - IGNORED */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_G16, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_G16, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	/* GPP_G18 - GPIO */
	/* DW0: 0x80100200, DW1: 0x00000000 */
	/* DW0: PAD_IRQ_ROUTE(IOAPIC) - IGNORED */
	/* PAD_CFG_GPO(GPP_G18, 0, PLTRST), */
	_PAD_CFG_STRUCT(GPP_G18, PAD_RESET(PLTRST) | PAD_IRQ_ROUTE(IOAPIC) | PAD_BUF(RX_DISABLE), 0),

	/* GPP_G19 - GPIO */
	/* DW0: 0x80880102, DW1: 0x00000000 */
	/* DW0: (1 << 1) - IGNORED */
	/* PAD_CFG_GPI_SCI(GPP_G19, NONE, PLTRST, LEVEL, INVERT), */
	_PAD_CFG_STRUCT(GPP_G19, PAD_RESET(PLTRST) | PAD_IRQ_ROUTE(SCI) | PAD_RX_POL(INVERT) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),

	/* GPP_G20 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_G20, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_G20, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_G21 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_G21, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_G21, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_G22 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_G22, NONE), */
	_PAD_CFG_STRUCT(GPP_G22, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),
	...
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_H0, NONE), */
	_PAD_CFG_STRUCT(GPP_H0, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_H1 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_H1, NONE), */
	_PAD_CFG_STRUCT(GPP_H1, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_H2 - GPIO */
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_H2, NONE), */
	_PAD_CFG_STRUCT(GPP_H2, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_H4, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_H5 - SRCCLKREQ11# */
	/* DW0: 0x40000700, DW1: 0x00000000 */
	/* DW0: PAD_BUF(TX_RX_DISABLE) - IGNORED */
	/* PAD_CFG_NF(GPP_H5, NONE, DEEP, NF1), */
	_PAD_CFG_STRUCT(GPP_H5, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_H6 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_H6, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_H6, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_H12, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),
	...
	/* DW0: 0x44000300, DW1: 0x00000000 */
	/* PAD_NC(GPP_H18, NONE), */
	_PAD_CFG_STRUCT(GPP_H18, PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE), 0),

	/* GPP_H19 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_H19, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_H19, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),

	/* GPP_H20 - GPIO */
	/* DW0: 0x84000102, DW1: 0x00000000 */
	/* DW0: (1 << 1) - IGNORED */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_H20, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_H20, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),

	/* GPP_H21 - GPIO */
	/* DW0: 0x84000201, DW1: 0x00000000 */
	/* PAD_CFG_GPO(GPP_H21, 1, PLTRST), */
	_PAD_CFG_STRUCT(GPP_H21, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE) | 1, 0),

	/* GPP_H22 - GPIO */
	/* DW0: 0x84000101, DW1: 0x00000000 */
	/* DW0: 1 - IGNORED */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_H22, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_H22, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | 1, 0),

	/* GPP_H23 - GPIO */
	/* DW0: 0x84000100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_TRIG_OWN(GPP_H23, NONE, PLTRST, OFF, ACPI), */
	_PAD_CFG_STRUCT(GPP_H23, PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPD1, PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),

	/* GPD2 - LAN_WAKE# */
	/* DW0: 0x00080502, DW1: 0x00001000 */
	/* DW0: PAD_BUF(TX_DISABLE) | (1 << 1) - IGNORED */
	/* PAD_CFG_NF(GPD2, DN_20K, PWROK, NF1), */
	_PAD_CFG_STRUCT(GPD2, PAD_FUNC(NF1) | PAD_IRQ_ROUTE(SCI) | PAD_BUF(TX_DISABLE) | (1 << 1), PAD_PULL(DN_20K)),
	...
	/* GPP_I3 - GPIO */
	/* DW0: 0x82040100, DW1: 0x00000000 */
	/* PAD_CFG_GPI_SMI(GPP_I3, NONE, PLTRST, EDGE_SINGLE, NONE), */
	_PAD_CFG_STRUCT(GPP_I3, PAD_RESET(PLTRST) | PAD_TRIG(EDGE_SINGLE) | PAD_IRQ_ROUTE(SMI) | PAD_BUF(TX_DISABLE), 0),
